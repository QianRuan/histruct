...
DATASET = 'arxiv'
PATH = '' #root dir
DATA_PATH = PATH+'data_arxiv/data_arxiv_roberta/arxiv'
TEMP_DIR = PATH+'temp'
...
MAX_NSENT = 1300 #should be set to a number that is larger than the number of input sentences
...
SECTION_NAMES_EMBED_PATH = 'data_arxiv/data_arxiv_raw/section_names_embed_longformerB_sum.pt'
#the classified STE injected
#SECTION_NAMES_EMBED_PATH = 'data_arxiv/data_arxiv_raw/section_names_embed_longformerB_sumCLS10.pt '
